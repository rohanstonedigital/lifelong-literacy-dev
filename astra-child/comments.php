...
// disable comments on courses, lessons, and topics for non-logged in users
if ( get_post_type() === 'sfwd-courses' || get_post_type() === 'sfwd-lessons' || get_post_type() === 'sfwd-topic' ) {
...
<div id="comments" class="comments-area">
	<?php echo do_shortcode('[lessons_navigation]'); ?>
